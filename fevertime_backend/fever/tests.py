...
class FeverTestCase(TestCase):
    def setUp(self):
        user1 = User.objects.create_user(username="youngjae", 
                                         password="youngjae", 
                                         nickname="youngjae")
        user2 = User.objects.create_user(username="youngjae2", 
                                         password="youngjae2", 
                                         nickname="youngjae2")
    ...
    def test_fever_history(self):
        ...
        # 405 테스트
        response = client.patch('/api/fever_history/',
                                json.dumps({'id': '1'}),
                                content_type='application/json')
    ...
    def test_fever_progress(self):
        ...
        response = client.post('/api/fever_progress/', 
                               json.dumps({'image': '1', 'id' : 0}),
                              content_type='application/json')
        self.assertEqual(response.status_code, 404)
